...
def setMaterialsList(data):
    ...
    for material in data:
        ...
        materialsList.append(Material(name,type,demrec,demener,demwaste,brorec,broener,browaste,price))
...
if __name__=='__main__':
    ...
    while not main_selector=="quit":
        if main_selector=="add":
            ...
            print("Recovery Rate : {} %\n Energy Recovery Rate : {} %\n Residual Waste Rate : {} %".format(100*arrondi(b[0],arrond_const),100*arrondi(b[1],arrond_const),100*arrondi(b[2],arrond_const)))
            ...
            while not mixed_selector=="quit_mixed":
                if mixed_selector=="main":
                    ...
                    print("Recovery Rate : {} %\n Energy Recovery Rate : {} %\n Residual Waste Rate : {} %".format(100*arrondi(c[0],arrond_const),100*arrondi(c[1],arrond_const),100*arrondi(c[2],arrond_const)))

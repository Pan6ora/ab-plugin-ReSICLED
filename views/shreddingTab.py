...
class ShreddingTab(QTabWidget):
    ...
    def call_show_table_dismantling_product(self,index):
        ...
        self.title_product.setText('<h1 style=""> '+selected_product["name_product"]+' shredding values </h1>')
        self.datamodel=Datamodel()
        self.data_list = self.datamodel.getShredding_data(selected_product["id_product"])
